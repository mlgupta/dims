...
<html>
  <head>
    ...
    <title>DBSentry - Digital Imaging Management System (Edit User)</title>
      ...
      function validateAndSubmit(){
        ...
        if(validateUserNewEditForm(thisForm)){
          ...
          if(thisForm.cboDepartments.value=="-1"){
            alert("<bean:message key="errors.select.department"/>");  
  ...
  <body>
    <html:form action="/editUserAction" name="userNewEditForm" type="dims.web.actionforms.users.UserNewEditForm" onsubmit="return validateUserNewEditForm(this);" focus="cboDepartments" >
    <html:hidden name="userNewEditForm" property="hdnUserTblPk" />
          ...
          <fieldset style="width:770px;">
            ...
            <table width="400px" border="0" align="center" cellpadding="1" cellspacing="1" class=" " style="margin-top:3px; margin-bottom:3px">
              ...
              <tr>
                ...
                <td align="left">
                  <html:password name="userNewEditForm" property="txtUserPassword" value="PasswordNotChanged12" redisplay="false" styleClass="bdrClr_Lvl_2" style="width:166px" maxlength="20" tabindex="3" />
                </td>
              </tr>
              <tr>
                <td align="right"><span class="textRed">* </span>Confirm Password:</td>
                <td align="left">
                  <html:password name="userNewEditForm" property="txtConfirmPassword" value="PasswordNotChanged12" redisplay="false" styleClass="bdrClr_Lvl_2" style="width:166px" maxlength="20" tabindex="4" />
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <td height="50" colspan="2" align="right">
                  ...
                  <input name="button" type="button" Class="buttons bdrClr_Lvl_2" style="width:50px; height:18px; margin-right:3px" tabindex="9" value="Cancel" onclick="cancelEdit();" />
