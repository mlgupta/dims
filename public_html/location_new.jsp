...
<html>
  <head>
    ...
    <title>DBSentry - Digital Imaging Management System (Create New Location)</title>
  ...
  <body>
    <html:form action="/newLocationAction" name="locationNewEditForm" type="dims.web.actionforms.location.LocationNewEditForm" onsubmit="return validateLocationNewEditForm(this);" focus="txtLocationID" >
          ...
          <legend>Add New  Location:</legend>
            <table width="400px" border="0" align="center" cellpadding="1" cellspacing="1" class=" " style="margin-top:3px; margin-bottom:3px">
              ...
              <tr>
                ...
                <td align="left">
                  <html:text name="locationNewEditForm" property="txtLocationNo" styleClass="bdrClr_Lvl_2" style="width:166px" readonly="true" value="new" />
                </td>
              </tr>
              ...
              <tr>
                ...
                <td width="358" align="left">
                  <html:text name="locationNewEditForm" property="txtLocationID" styleClass="bdrClr_Lvl_2" style="width:166px" tabindex="1" />
                </td>
              </tr>
              ...
              <tr>
                ...
                <td align="left">
                  <html:text name="locationNewEditForm" property="txtLocationDescription" styleClass="bdrClr_Lvl_2" style="width:166px" tabindex="2" />
                </td>
              </tr>
              ...
              <tr>
                ...
                <td align="left">
                  <html:text name="locationNewEditForm" property="txtLocationCity" styleClass="bdrClr_Lvl_2" style="width:166px" tabindex="3" />
                </td>
              </tr>
              ...
              <tr>
                ...
                <td align="left">
                  <html:text name="locationNewEditForm" property="txtLocationZipcode" styleClass="bdrClr_Lvl_2" style="width:166px" tabindex="4" onkeypress="return integerOnly(event);" maxlength="6" />
                </td>
              </tr>
              ...
              <tr>
                ...
                <td align="left">
                  <html:select name="locationNewEditForm" property="txtLocationState" styleClass="bdrClr_Lvl_2" style="width:166px" tabindex="5" >
              ...
              <tr>
                ...
                <td align="left">
                  <html:select name="locationNewEditForm" property="txtLocationCountry" styleClass="bdrClr_Lvl_2" style="width:166px" tabindex="6">
              ...
              <tr>
                <td height="50" colspan="2" align="right">
                  <input name="saveButton" type="button" Class="buttons bdrClr_Lvl_2" style="width:50px; height:18px; margin-right:3px" tabindex="7" value="Save" onclick="validateAndSubmit();" >
                  <input name="cancelButton" type="button" Class="buttons bdrClr_Lvl_2" style="width:50px; height:18px; margin-right:3px" tabindex="8" value="Cancel" onclick="cancelNew();" >
                  <input name="resetButton" type="button" Class="buttons bdrClr_Lvl_2" style="width:50px; height:18px; margin-right:83px" tabindex="9" value="Reset" onclick="return resetFields();" >
                </td>
              </tr>
            </table>
            </fieldset>	
