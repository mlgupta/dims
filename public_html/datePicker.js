...
function Calendar(calId,calWidth,calHeight,isTo){
  /********** Properties ****************/
...
function ShowCalendar(theDate){
	...
	varCal ="<table border='0'  cellspacing='2' cellpadding='1' class='imgData borderClrLvl_2 bgClrLvl_F' width='"+ this.calWidth + "px' >";	
  //Timezone combo 
	if(!this.noTimezone){
    varCal += "<tr>";
	...
	for ( var r = 1; r <= 6; r++ ) {
      ...
      //Current Month Dates cells 
            ...
            cellPrefix="<th " 	
						...
						cellPrefix= "<td class='borderClrLvl_2 bgClrLvl_F' ";
						cellSuffix="</td>";	
				}
...
function dateWithTimezone(varDate,varTimezoneName){
  ...
  return varDate.substring(0,lastIndex) + " 00:00:00"
}
