...
<html>
  <head>
    ...
    <title>DBSentry - Digital Imaging Management System (Create New Rack)</title>
  ...
  <body>
    <html:form action="/newRackAction" name="rackNewEditForm" type="dims.web.actionforms.rack.RackNewEditForm" focus="txtRackNumber">
    <html:hidden name="rackNewEditForm" property="hdnRackTblPk" value="" />
            ...
            <table width="400px" border="0" align="center" cellpadding="1" cellspacing="1" class=" " style="margin-top:3px; margin-bottom:3px">
              ...
              <tr>
                <td height="50" colspan="2" align="right">
                  ...
                  <input name="CancelButton" type="button" Class="buttons bdrClr_Lvl_2" style="width:50px; height:18px; margin-right:3px" tabindex="6" value="Cancel" onclick="cancelNew();" />
