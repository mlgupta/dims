...
<html>
  <head>
    ...
    <title>DBSentry - Digital Imaging Management System (Edit Room)</title>
  ...
  <body>
    <html:form action="/editRoomAction" name="roomNewEditForm" type="dims.web.actionforms.room.RoomNewEditForm" focus="cboLocations" >
    <html:hidden name="roomNewEditForm" property="hdnRoomTblPk" />
            ...
            <table width="400px" border="0" align="center" cellpadding="1" cellspacing="1" class=" " style="margin-top:3px; margin-bottom:3px">
              ...
              <tr>
                <td height="50" colspan="2" align="right">
                  ...
                  <input name="editButton" type="button" Class="buttons bdrClr_Lvl_2" style="width:50px; height:18px; margin-right:3px" tabindex="5" value="Cancel" onclick="cancelEdit();" />
