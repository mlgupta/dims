...
<html>
  <head>
    ...
    <title>DBSentry - Digital Imaging Management System (Edit Binder Prefix)</title>
  ...
  <body>
    <html:form action="/editBinderAction" name="binderNewEditForm" type="dims.web.actionforms.binders.BinderNewEditForm" onsubmit="return validateBinderNewEditForm(this);" focus="txtBinderPrefixName" >
            ...
            <table width="400px" border="0" align="center" cellpadding="1" cellspacing="1" class=" " style="margin-top:3px; margin-bottom:3px">
              ...
              <tr>
                <td height="50" colspan="2" align="right">
                  ...
                  <input name="cancelButton" type="button" Class="buttons bdrClr_Lvl_2" style="width:50px; height:18px; margin-right:3px" tabindex="4" value="Cancel" onclick="cancelEdit();" />
