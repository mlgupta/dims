...
public class NewBinderAction extends Action  {
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
    ...
    logger.info("Entering NewBinderAction***");
    
    try {
      session = request.getSession(false);
      binderNewEditForm = (BinderNewEditForm)form;
      DataSource ds = getDataSource(request,"DIMS");
      Operations.addBinderPrefix(ds,binderNewEditForm);
      msg = new ActionMessage("msg.new.binderPrefix",binderNewEditForm.getTxtBinderPrefixName());
      messages.add("newBinderPrefix",msg);
    }catch (SQLException sqle) {
      logger.error("An error occured in NewBinderAction");
    ...
    logger.info("Exiting NewBinderAction***");
