...
public class NewRackAction extends Action  {
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
    ...
    logger.info("Entering NewRackAction***");
    
    try {
      session = request.getSession(false);
      rackNewEditForm = (RackNewEditForm)form;
      DataSource ds = getDataSource(request,"DIMS");
      Operations.addRack(ds,rackNewEditForm);
      msg = new ActionMessage("msg.new.rackNumber",rackNewEditForm.getTxtRackNumber(),rackNewEditForm.getTxtNumberOfShelves());
      messages.add("newRack",msg);
    }catch (SQLException sqle) {
      logger.error("An error occured in NewRackAction");
    ...
    logger.info("Exiting NewRackAction***");
